...
public class TaskAnswerTextsController extends BaseController {    
     ...
     */
    public DynamicResponse getTaskAnswerTextsGet(
                final int id,
                final String acceptLanguage
    ) throws Throwable {
        APICallBackCatcher<DynamicResponse> callback = new APICallBackCatcher<DynamicResponse>();
        getTaskAnswerTextsGetAsync(id, acceptLanguage, callback);
    ...
    public void getTaskAnswerTextsGetAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5256212644462229691L;
            {
                    put( "id", id );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5548339209204197876L;
            {
