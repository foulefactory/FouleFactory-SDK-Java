...
public class TaskLinesController extends BaseController {    
     ...
     */
    public DynamicResponse createTaskLinesCreateTaskLine(
        ...
        createTaskLinesCreateTaskLineAsync(taskLines, acceptLanguage, callback);
    ...
    public void createTaskLinesCreateTaskLineAsync(
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5446296533004735240L;
            {
     ...
     * @return    Returns the DynamicResponse response from the API call 
     */
    public DynamicResponse getTaskLinesGetTasksByLine(
                final int id,
                final String acceptLanguage
    ) throws Throwable {
        APICallBackCatcher<DynamicResponse> callback = new APICallBackCatcher<DynamicResponse>();
        getTaskLinesGetTasksByLineAsync(id, acceptLanguage, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void getTaskLinesGetTasksByLineAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5596274158806457938L;
            {
                    put( "id", id );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4651972800378339179L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Accept-Language", (null != acceptLanguage) ? acceptLanguage : "fr" );
     ...
     * @return    Returns the DynamicResponse response from the API call 
     */
    public DynamicResponse getTaskLinesGet(
                final int id,
                final String acceptLanguage
    ) throws Throwable {
        APICallBackCatcher<DynamicResponse> callback = new APICallBackCatcher<DynamicResponse>();
        getTaskLinesGetAsync(id, acceptLanguage, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
    ...
    public void getTaskLinesGetAsync(
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5290173312846799208L;
            {
                    put( "id", id );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4640855328941153262L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Accept-Language", (null != acceptLanguage) ? acceptLanguage : "fr" );
