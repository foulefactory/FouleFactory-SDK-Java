...
public class TaskAnswerChoicesController extends BaseController {    
     ...
     */
    public DynamicResponse getTaskAnswerChoicesGet(
                final int id,
                final String acceptLanguage
    ) throws Throwable {
        APICallBackCatcher<DynamicResponse> callback = new APICallBackCatcher<DynamicResponse>();
        getTaskAnswerChoicesGetAsync(id, acceptLanguage, callback);
    ...
    public void getTaskAnswerChoicesGetAsync(
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4692489755156593611L;
            {
                    put( "id", id );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5558864806530767348L;
            {
