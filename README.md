...
=============
    ...
    2. Open a command prompt and navigate to the JavaSDK/FouleFactoryApiLib folder.
    ...
    4.In your own maven application, add the following lines which will refer to newly installed SDK: 
        <dependency>
            <groupId>FouleFactoryApiLib</groupId>
            <artifactId>FouleFactoryApiLib</artifactId>
...
Exporting JARs:
    ...
    3. Check the box beside "FouleFactoryApiLib" and click on "Finish".
